...
export default function CustomerTable({ title, description, data } : CustomerTableProps) {
  return (
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {data.map((person: any) => (
              <tr key={person.email}>
                ...
                <td className="hidden px-3 py-4 text-sm text-gray-500 sm:table-cell">{person.tel}</td>
